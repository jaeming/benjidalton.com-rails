class Portfolio < ActiveRecord::Base
  ...
  def self.upload(file)
    ...
    authorization_response = Portfolio.authorize_account
    ...
    upload_response = Portfolio.get_upload_url(auth_token, api_url)
    upload_url = upload_response["uploadUrl"]
    upload_token = upload_response["authorizationToken"]

    #upload image
    upload_response = Portfolio.upload_image(upload_url, file, upload_token)
